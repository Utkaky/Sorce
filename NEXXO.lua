if game.Players.LocalPlayer.Name == "NexxoGEN" or "IPstriker" or "TheR1vers1vE" then
    local HubName = "NEXXAGEN"
    local hui = false
   ...
   -- local getmsg = game:GetService("ReplicatedStorage"):WaitForChild("DefaultChatSystemChatEvents"):WaitForChild("OnMessageDoneFiltering")
    ...
    --.ChatBarParentFrame.Position = chatFrame.ChatChannelParentFrame.Position+UDim2.new(UDim.new(),chatFrame.ChatChannelParentFrame.Size.Y)
    ...
    OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/GameLandHub/Script/refs/heads/main/Orion/Library.luau"))()
